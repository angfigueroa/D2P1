...
void uint8ToString(uint8_t num, char *str) {
    ...
    str[i] = '\0';  // Agregar el car?cter nulo para indicar el final de la cadena
    reverse(str, i); // Invertir la cadena para que est? en el orden correcto
}
...
void main(void) {
    ...
    while(1){
        ...
        //comunicaci?n con sensor de temperatura
